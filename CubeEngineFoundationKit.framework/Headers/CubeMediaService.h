...
#pragma mark - multiMediaStreams service
@protocol CubeMediaMultiStreamsService<NSObject>
...
/**
 ...
 @param height 高
 */
- (void)changeCaptureFormat:(NSString *)conferenceId cubeId:(NSString *)cubeId width:(CGFloat )width height:(CGFloat )height;
...
/**
 ...
 @return 是否开启
 */
- (BOOL)isVideoEnabled:(NSString *)conferenceId cubeId:(NSString *)cubeId;
...
/**
 ...
 @param enable 开关
 */
- (void)setVideoEnabled:(NSString *)conferenceId cubeId:(NSString *)cubeId videoEnable:(BOOL )enable;
...
/**
 ...
 @return 是否开启
 */
- (BOOL)isAudioEnabled:(NSString *)conferenceId cubeId:(NSString *)cubeId;
...
/**
 ...
 @param enable 开关
 */
- (void)setAudioEnabled:(NSString *)conferenceId cubeId:(NSString *)cubeId audioEnable:(BOOL )enable;
